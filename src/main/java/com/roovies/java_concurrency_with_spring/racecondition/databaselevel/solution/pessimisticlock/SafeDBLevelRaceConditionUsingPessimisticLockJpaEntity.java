...
@AllArgsConstructor
@Getter
public class SafeDBLevelRaceConditionUsingPessimisticLockJpaEntity {
    @Id
    ...
    public SafeDBLevelRaceConditionUsingPessimisticLockJpaEntity(String productName, Integer quantity) {
