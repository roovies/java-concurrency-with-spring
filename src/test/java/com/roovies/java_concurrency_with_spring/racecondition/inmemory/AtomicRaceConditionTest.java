...
import com.roovies.java_concurrency_with_spring.racecondition.inmemory.service.AtomicStockService;
...
public class AtomicRaceConditionTest {
    ...
    private final AtomicStockService stockService = new AtomicStockService();
